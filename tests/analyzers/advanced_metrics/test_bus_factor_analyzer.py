...
class TestBusFactorAnalyzer(unittest.TestCase):
    ...
    def test_bus_factor_calculation(self):
        ...
        bus_factor, coverage_analysis = self.analyzer._calculate_bus_factor(
            knowledge_weights, 0.8
        )
    ...
    def test_recommendations_generation(self):
        ...
        critical_recs = self.analyzer.get_recommendations({
            'bus_factor': 1,
        ...
        # Test good scenario
        good_recs = self.analyzer.get_recommendations({
            'bus_factor': 5,
