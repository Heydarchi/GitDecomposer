...
from tests.test_config import cleanup_test_environment, setup_test_environment
...
def main():
    ...
    parser.add_argument("--list", "-l", action="store_true", help="List available test classes")
