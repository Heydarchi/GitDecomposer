...
class ContributorInfo:
    ...
    def is_active_in_period(self, start_date: datetime, end_date: datetime) -> bool:
        ...
        return (self.first_commit_date and self.last_commit_date and
                self.first_commit_date <= end_date and self.last_commit_date >= start_date)
